  ...
  return (
    <div className="p-6">
      ...
      <div className="border border-t-0 rounded-b p-4">
            ...
            <tbody>
              {paginadas.map((s) => (
                <tr key={s.id} className="border-t">
                  <td className="p-2 font-medium">{s.link_sistema || '-'}</td>
                  <td className="p-2 font-medium">{s.ip_puerto || '-'}</td>
                  <td className="p-2 uppercase">{s.nombre_usuario}</td>
        ...
        {paginadas.length === 0 && <p className="text-gray-500 mt-4">Sin accesos activos.</p>}
